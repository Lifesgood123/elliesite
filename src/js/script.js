$(document).ready(function() {
    ...
    $("span[name='lib']").click(function(){
        document.getElementById("searchbar").setAttribute("action", "/search")
    });
    ...
    $("span[name='lostwoods']").click(function() {
        document.getElementById("stylesheet").setAttribute("href", "styles/lostwoods.css");
    });
    $("span[name='anime']").click(function() {
        document.getElementById("stylesheet").setAttribute("href", "styles/anime.css");
    });
    $("span[name='simple']").click(function() {
        document.getElementById("stylesheet").setAttribute("href", "styles/simple.css");
    });
    $("span[name='cute']").click(function() {
        document.getElementById("stylesheet").setAttribute("href", "styles/botw1.css");
    });
    $("span[name='botw']").click(function() {
        document.getElementById("stylesheet").setAttribute("href", "styles/botw2.css");
    });
